...
<div class="container">
    <div class="row">
        <div class="nv-content-wrap col">
            <h1 class="page-title"><?php echo esc_html__('Testimonials', 'neve'); ?></h1>
            ...
            if ($query->have_posts()) {
                ...
                if (current_user_can('manage_options')) {
                    ...
                    echo '<p>' . esc_html__('Admin notice: No testimonials found. Try adding some from the WordPress admin area.', 'neve') . '</p>';
                    ...
                    echo '<div style="margin-top: 15px; padding: 10px; background: #f1f1f1; border-left: 4px solid #ccc;">';
                    echo '<p><strong>Debug information:</strong></p>';
                    echo '<ul>';
                    echo '<li>Post type: testimonial</li>';
                    echo '<li>Custom fields being searched: customer_name, customer_review, verified_purchase, review_date</li>';
                    
                    // Count all testimonials in the database (including any status)
                    ...
                    echo '<li>Total testimonials in database (any status): ' . count($all_testimonials) . '</li>';
                    echo '</ul>';
                    echo '</div>';
