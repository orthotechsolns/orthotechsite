 ...
 * 
 * This template handles all categories under the 'products' taxonomy URL structure.
 *
 * @package Neve
 */

$container_class = apply_filters( 'neve_container_class_filter', 'container', 'taxonomy-products' );
